...
describe('Day 14', function() {
  ...
  describe('Part 2', function() {
    it('Test case 1', function() {
      ...
      assert.equal(part1(reactions), 13312)
      assert.equal(part2(reactions), 82892753)
    })
    ...
    it('Test case 2', function() {
      ...
      assert.equal(part1(reactions), 180697)
      assert.equal(part2(reactions), 5586022)
    })
    ...
    it('Test case 3', function() {
      ...
      assert.equal(part1(reactions), 2210736)
      assert.equal(part2(reactions), 460664)
    })
  })
})
