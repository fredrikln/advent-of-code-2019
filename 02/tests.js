...
describe('Day 2', function() {
  describe('Part 1', function() {
    it('1,0,0,0,99', function() {
      const input = parseMemoryFromString('1,0,0,0,99')
    ...
    it('2,3,0,3,99', function() {
      const input = parseMemoryFromString('2,3,0,3,99')
      const output = intcode(input)
    ...
    it('2,4,4,5,99,0', function() {
      const input = parseMemoryFromString('2,4,4,5,99,0')
      const output = intcode(input)
    ...
    it('1,1,1,4,99,5,6,0,99', function() {
      const input = parseMemoryFromString('1,1,1,4,99,5,6,0,99')
      const output = intcode(input)
